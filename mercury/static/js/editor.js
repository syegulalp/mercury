...
function save_draft_and_preview() {
    if (window.onbeforeunload == stay){
        global.save_callback=show_preview_only;
        page_save(1);
    }
    else
    {
