...
% for m in page.media:
  <li class="list-group-item wrap-txt" data-toggle="tooltip" data-placement="left"
      data-html="true"
      title="<div style='background-color:white'><img style='max-width:180px;' src='{{m.preview_url}}'></div>">
      <span
      ...
      <a title="See details about this image in the image manager" target="_blank" href="{{settings.BASE_URL}}/blog/{{page.blog.id}}/media/{{m.id}}/edit">{{m.friendly_name}}</a> [#<i>{{m.id}}</i>]
  </li>
% end
</ul>
% end